...
for cutoff in cutoffs:
    ...
    pnas_shuff_vals = pnas_d.values()
    random.shuffle(pnas_shuff_vals)

    pnas_d = dict(zip(pnas_d.keys(), pnas_shuff_vals))
...
joblib.dump(mr, './HUVEC_AUROC_removal_titration_results_randomprobs')
